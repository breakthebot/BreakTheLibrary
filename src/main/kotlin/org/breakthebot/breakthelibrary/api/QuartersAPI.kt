...
object QuartersAPI {
    ...
    suspend fun getAllQuarters(): List<Reference>? = getRequest(Endpoints.QUARTERS)

    suspend fun getQuarter(quarters: List<UUID>): List<Quarter>? = postRequest(Endpoints.QUARTERS, quarters.map { it.toString() })
}